...
# Use "main" for the final 500-replication simulation.
# With overwrite = FALSE and the same RESULTS_ROOT, existing 200-replication
# results are reused and only replications 201--500 are computed.
RUN_MODE <- "main"
# RUN_MODE <- "pilot"
